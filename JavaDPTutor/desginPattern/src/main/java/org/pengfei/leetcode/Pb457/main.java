package org.pengfei.leetcode.Pb457;
...
public class main {
    ...
    private int advance(int[] nums, int i) {
        //get the value of current pointer
        i = i+nums[i];

        //if the value is negative, it means the pointer will step backward through the beginning of the array
        if (i < 0) i = i+ len;
        //if the value is bigger than the size of array-1, it means the pointer will step forward to the beginning of the array
