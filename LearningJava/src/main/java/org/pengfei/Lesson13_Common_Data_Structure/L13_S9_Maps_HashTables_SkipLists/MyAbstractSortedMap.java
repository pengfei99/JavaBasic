 ...
 *
 */
public abstract class MyAbstractSortedMap<K,V>
        extends MyAbstractMap<K,V> implements MySortedMap<K,V> {
     ...
     */
    protected MyAbstractSortedMap(Comparator<K> c) {
        comp = c;
    }

    /** Initializes the map with a default comparator. */
    protected MyAbstractSortedMap() {
